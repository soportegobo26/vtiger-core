...
<div class="listViewPageDiv">
	...
	<div class="listViewActionsDiv row-fluid">
	    ...
	    <span class="span4 btn-toolbar">
	    	{include file='ListViewSwitch.tpl'|@vtemplate_path:$MODULE LIST=true CANVAS=false SCHEDULE=true TIMELINE_SWITCH=false}
	    </span>
	</div>
    </div>
</div>
<div id="help_mobile" style="color: red; margin-left: 20px;"></div>
<div class="canvas">
    ...
    <div class="potentialbyfase">
	<table>
	    <tr>
			<td class="potentialbyfase_top">
			    <ul>
			    {foreach key=key item=item from=$SALES_STAGE}
				<li id="{$item}" class="sales_stage" data-stage="{$item}">
				    <div class="stagename"><span>{$item}</span></div>
				    <div class="stageinfo">
					    <div class="stagecurrency"><img src="layouts/vlayout/modules/Canvas/resources/images/currency.png"></div>
						<div class="stagevalue"></div>
						<div class="stagenumber"></div>
						<div class="spanname"> {vtranslate('Potentials', 'Potentials')} </div>
				    </div>
				</li>
			    {/foreach}
			    </ul>
	    ...
	    <tr>
			<td class="potentialbyfase_middle">
			    <div class="test">
					<div class="gridster">
					    <ul>
						<!-- item-template -->
	...
	<div id="dealActions" class="potentialbyfase_footer">
		<ul class="closeDeal">
		    <li class="clear">
			&nbsp;
		    </li>
    ...
    <div class="emptystate hide" style="text-align:center; width:100%; background-color: #eeeeee;">
		<!-- Empty State -->
		<a href="https://www.datacrm.com/ayuda/index.php/2015/07/30/manejo-de-canvas/" target="_blank"> 
			<img src="layouts/vlayout/skins/datacrm/images/canvasNull.png" alt="Canvas">
		</a>
    </div>
</div>
...
<script type="text/x-underscore" id='item-template'>
    <li data-stage="<%=sales_stage%>" data-related_account="<%=accountid%>" data-contact_id="<%=contact_id%>" data-record="<%=potentialid%>" >
	<div class="block">
	    <div class="core">
	    	<div>
	    ...
	    <div class="labels">
	        ...
	        <div id="value_<%=potentialid%>"> <%=format%> </div>
	        <div>
		    	<span id="icon_<%=potentialid%>" data-potentialid="<%=potentialid%>" class="row-icon row-icon-<%=color%>"></span>
	        </div>
	    </div>
	</div>
    </li>
...
<script type="text/x-underscore" id='activity-template'>
	...
	<div class="des_activity">
	    ...
	    <div id="canvas_description"> <%=description%> </div>
	</div>
    </div>
</script>